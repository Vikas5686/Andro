...
import Servic_card from "./Servic_card.js";
    ...
    return (
        <div>
            <div className="service_page">
                ...
                <button className="Btn_all floatLeft_button">Get quotation</button>
                <Servic_card id={0} id2={1} id3={2} />
                <div className="programming">
                <h3 className="black Head_line float_right_heading">Programing</h3>
                <button className="Btn_all float_right_button">Get quotation</button>
